...
<head>
    ...
    <title>Goblin Gizmos - Bottle Caps</title>
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'caps') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div class="grayBoxInInfo">
                    ...
                    <h2>Bottle Caps</h2>
                    <p>A bottle cap is a cap that keeps a bottle closed. They increase in value due to rarity. One may
                        collect bottle caps due to the picture on the top of it, as a resource to make into jewelry, or
                        for
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'caps') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'caps') && ($row2['post_or_bounty'] == 'post')) {
