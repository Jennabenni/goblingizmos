...
<head>
    ...
    <title>Goblin Gizmos - Cans</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'cans') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/cans.png" alt="cans">
                </div>
                <div class="grayBoxInInfo">

                    <h2>Cans</h2>
                    <p>A can is a vessel that holds food, liquid, or other materials. Cans may be collected to be used
                        as a
                        decoration, due to the art on its surface, or to document consuming the contents within.
                    </p>
                </div>
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'cans') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'cans') && ($row2['post_or_bounty'] == 'post')) {
