...
<head>
    ...
    <title>Goblin Gizmos - Stamps</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'stamps') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/stamps.png" alt="cluster of stamps">
                </div>
                <div class="grayBoxInInfo">

                    <h2>Stamps</h2>
                    <p>Stamps are stickers that are placed in the corner of envelopes to ensure that they can be
                        delivered and transmitted elsewhere. These can also refer to an instrument with a carving on
                        the underside of it that leaves an impression behind when pressed into a surface and can contain
                        ink.
                    </p>
                </div>
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'stamps') && ($row['post_or_bounty'] == 'post')) {
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'stamps') && ($row2['post_or_bounty'] == 'post')) {
