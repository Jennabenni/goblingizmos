...
<head>
    ...
    <title>Goblin Gizmos - Charms </title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level'])) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'charms') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/charms.png" alt="charms">
                </div>
                <div class="grayBoxInInfo">


                    <h2>Charms</h2>
                    <p>A keychain is a decorative piece that generally hangs off of one's keys. A charm can also serve
                        this
                        purpose, but may not have a connecting piece. Individuals may collect these due to a personal
                        interest in the media from which the keychain depicts, and may be searching for an item that is
                        no
                        longer for sale. They are worth more with less damages to all aspects of the keychain/charm, but
                        the
                        chain can be replaced in most cases.
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin")) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'charms') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'charms') && ($row2['post_or_bounty'] == 'post')) {
