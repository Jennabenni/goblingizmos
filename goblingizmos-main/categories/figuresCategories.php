...
<head>
    ...
    <title>Goblin Gizmos - Figures</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'figures') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/figures.png" alt="SSJ Goku Figure">
                </div>
                <div class="grayBoxInInfo">

                    <h2>Figures</h2>
                    <p>'Figures' refers to figurines, which are statue-like objects of different portrayals. People may
                        be
                        after certain character depictions, rare collectibles, or custom-made figurines.
                    </p>
                </div>
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'figures') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'figures') && ($row2['post_or_bounty'] == 'post')) {
