...
<head>
    ...
    <title>Goblin Gizmos - Tickets</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level'])) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'tickets') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/tickets.png" alt="pile of tickets">
                </div>
                <div class="grayBoxInInfo">


                    <h2>Tickets</h2>
                    <p>Tickets are pieces of paper that are used as a proof of purchase for events and presented upon
                        entry
                        to verify that one may enter. Many collect these to put on display and represent an event that
                        they
                        went to but lost the ticket or to have a piece of memorabilia of their favorite band or other
                        event.
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin")) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'tickets') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'tickets') && ($row2['post_or_bounty'] == 'post')) {
