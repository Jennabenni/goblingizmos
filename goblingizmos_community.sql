...
(15, 3, 'uploads/tickets1.jpg', 'tickets', 'Oh yeah I am going here.  You cannot stop me', 'sfw', 0, '2026-04-08'),
(16, 4, 'uploads/videogames2.jpg', 'games', 'Sega', 'sfw', 0, '2026-04-04'),
(1, 5, 'uploads/vinyls2.jpg', 'vinyls', 'If you think the writing on these posts are weird, perhaps you should ignore it', 'nsfw', 0, '2026-04-03'),
(20, 6, 'uploads/other3.jpg', 'other', 'I love vague posting', 'sfw', 0, '2026-02-09'),
(19, 7, 'uploads/perfume3.jpg', 'perfume', 'how do I make posts man I cannot read', 'sfw', 0, '2026-04-12');
...
--
ALTER TABLE `goblingizmos_community`
  MODIFY `compost_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
