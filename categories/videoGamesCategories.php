...
<head>
    ...
    <title>Goblin Gizmos - Video Games</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'games') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/videoGames.png" alt="Orange Gameboy">
                </div>
                <div class="grayBoxInInfo">

                    <h2>Video Games</h2>
                    <p>Video games are digital games that can either be played on online platforms or through physical
                        cartridges or discs. The physical discs/cartridges are most likely what will be featured in this
                        category as a collectible, and may be collected based on rarity depending on how old the console
                        is that featured the game.
                    </p>
                </div>
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'games') && ($row['post_or_bounty'] == 'post')) {
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'games') && ($row2['post_or_bounty'] == 'post')) {
