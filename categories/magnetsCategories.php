...
<head>
    ...
    <title>Goblin Gizmos - Magnets</title>
    ...
    <div class="page-wrap">
        ...
        <div class="specificCategoryLayoutGrid">
                    ...
                    <div class="bigBountyOnCat">
                        ...
                        if (isset($_SESSION['access_level']) && $resultUserPartTwo) {
                            ...
                            while (($row3 = $resultUserPartTwo->fetch_array(MYSQLI_ASSOC))) {
                                if (($row3['post_category'] == 'magnets') && ($row3['post_or_bounty'] == 'bounty')) {
            ...
            <div class="specificCatItem3">
                ...
                <div>
                    <img src="../img/magnets.png" alt="several unique magnets">
                </div>
                <div class="grayBoxInInfo">

                    <h2>Magnets</h2>
                    <p>Magnets are items that connect to other items that are made of metal.</p>
                </div>
            ...
            <div class="specificCatItem5">
                ...
                if (isset($_SESSION['access_level']) && ($_SESSION['access_level'] == "admin") && $result) {
                    while (($row = $result->fetch_array(MYSQLI_ASSOC))) {
                        ...
                        if (($row['post_category'] == 'magnets') && ($row['post_or_bounty'] == 'post')) {
                            //IT'S THAT EASY???
                    ...
                    while (($row2 = $resultUser->fetch_array(MYSQLI_ASSOC))) {
                        if (($row2['post_category'] == 'magnets') && ($row2['post_or_bounty'] == 'post')) {
